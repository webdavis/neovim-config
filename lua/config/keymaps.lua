...
--   lhs = "<leader>p",
--   rhs = [[viw"_dP]],
--   desc = "Replace <cword-under-cursor> with yanked text",
--   expr = true,
-- })
...
--   lhs = "<C-_>",
--   rhs = "ToggleTerm",
--   desc = "Toggleterm: Toggle (open/close)",
-- })

-- Copy, Cut, Paste clipboard integration.
-- map({ mode = "x", lhs = "<C-c>", rhs = '"+y', desc = "Copy to Clipboard", expr = true })
-- map({ mode = "x", lhs = "<C-g>", rhs = '"+p', desc = "Paste from Clipboard", expr = true })
